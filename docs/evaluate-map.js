function asyn(callback) {
    ...
    $("#article-txt-id a").click(function () {
        ...
        $('#main-txt-id').empty();
        $('#main-txt-id').load(nuovofile + " #main-txt-id", function () {
            $('#sidebar-txt-id').empty();
            $('#sidebar-txt-id').load(nuovofile + " #sidebar-txt-id", function () {
                $('#button-txt-id').empty();
                $('#button-txt-id').load(nuovofile + " #button-txt-id", function () {
                    callback();
                });
            });
        });
