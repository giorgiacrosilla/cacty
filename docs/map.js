...
$(document).ready(function () {
    $('div[data-name]').on('click', function () {
        ...
        if (elementToAssignId.hasClass('person')) {
            if (elementToAssignId.hasClass('stylePerson')) {
                elementToAssignId.removeClass('stylePerson');
                console.log('Person unchecked');
            } else {
                elementToAssignId.addClass('stylePerson');
                console.log('Person checked');
            }
        } else if (elementToAssignId.hasClass("event")) {
            if (elementToAssignId.hasClass('styleEvent')) {
                elementToAssignId.removeClass('styleEvent');
                console.log('Event unchecked');
            } else {
                elementToAssignId.addClass('styleEvent');
                console.log('Event checked');
            }
        } else if (elementToAssignId.hasClass("date")) {
            if (elementToAssignId.hasClass('styleDate')) {
                elementToAssignId.removeClass('styleDate');
                console.log('Date unchecked');
            } else {
                elementToAssignId.addClass('styleDate');
